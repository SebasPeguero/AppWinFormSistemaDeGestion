...
namespace PSC10SP
{
    public partial class frmVENCAT : Form
    {
        public frmVENCAT()
        {
            InitializeComponent();
        ...
        private void BuscarData(string _strBuscar)
        {
            ...
            string _query = "SELECT CATEGORIA, CategoriaNombre " +
                "FROM CATEGORIAS WHERE CategoriaNombre LIKE '%" + _strBuscar + "%'  ORDER BY CategoriaNombre ASC";
            ...
            while (rdr.Read())
            {
                ...
                dgv[0, nRow].Value = rdr["CATEGORIA"].ToString();
                dgv[1, nRow].Value = rdr["CategoriaNombre"].ToString();
            }
        ...
        private void EstiloDGV()
        {
            ...
            this.dgv.Columns.Add("B", "DETALLE");
