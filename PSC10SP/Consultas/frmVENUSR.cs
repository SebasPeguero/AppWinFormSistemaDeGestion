...
namespace PSC10SP
{
    public partial class frmVENUSR : Form
    {
       ...
       public Boolean EData; //usada para verificar si transporta la data al form padre
        public string var1; //Data transportada columna 0 al presionar doble click o seleccionada
        public string var2; //Data transportada columna 1
        ...
        private void BuscarData(string _strBuscar)
        {
            ...
            string _query = "SELECT NOMBRECORTO, NOMBRE " +
                "FROM USUARIO WHERE NOMBRE LIKE '%" + _strBuscar + "%' ORDER BY NOMBRE ASC";
            ...
            while (rdr.Read()) 
            {
                ...
                dgv[0, nRow].Value = rdr["NOMBRECORTO"].ToString();
                dgv[1, nRow].Value = rdr["NOMBRE"].ToString();
            }
        ...
        private void EstiloDGV()
        {
            ...
            this.dgv.Columns.Add("A", "USUARIO");
            this.dgv.Columns.Add("B", "NOMBRES APELLIDOS");
