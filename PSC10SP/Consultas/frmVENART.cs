...
namespace PSC10SP
{
    public partial class frmVENART : Form
    {
        ...
        private void BuscarData(string _strBuscar)
        {
            ...
            string _query = "SELECT IDPRODUCTO, DESCRIPCION " +
                "FROM PRODUCTOS WHERE ESTATUS = 1 AND DESCRIPCION LIKE '%" + _strBuscar + "%' ORDER BY DESCRIPCION ASC";
            ...
            while (rdr.Read())
            {
                ...
                dgv[0, nRow].Value = rdr["IDPRODUCTO"].ToString();
                dgv[1, nRow].Value = rdr["DESCRIPCION"].ToString();
            }
        ...
        private void EstiloDGV()
        {
            ...
            this.dgv.Columns.Add("A", "Articulo");
